...
INSERT INTO contract (client_id, amount, contract_type, date_start, date_end, account_id) VALUES
  (1,3223, 'SALE', '2016-03-25','2016-05-24',1),
  (2,6346, 'RENEWAL', '2017-03-09','2017-04-23',2),
  (3,6127, 'UPGRADE', '2017-10-11','2017-12-06',3),
  (4,3273, 'SALE', '2016-09-28','2016-11-20',4),
  (5,4713, 'RENEWAL', '2016-05-01','2016-06-19',1),
  (6,3034, 'UPGRADE', '2016-01-12','2016-03-12',2),
  (7,9982, 'SALE', '2016-02-20','2016-04-08',3),
  (8,5122, 'RENEWAL', '2017-07-20','2017-08-30',4),
  (9,8960, 'UPGRADE', '2016-06-30','2016-07-31',1),
  (10,4628, 'SALE', '2016-11-03','2016-12-31',2),
  (1,8529, 'RENEWAL', '2016-05-03','2016-06-23',3),
  (2,1033, 'UPGRADE', '2016-05-27','2016-07-23',4),
  (3,9201, 'SALE', '2016-01-02','2016-03-01',1),
  (4,5256, 'RENEWAL', '2017-04-25','2017-06-15',2),
  (5,8803, 'UPGRADE', '2017-10-31','2017-12-14',3),
  (6,4842, 'SALE', '2016-09-03','2016-10-08',4),
  (7,5589, 'RENEWAL', '2016-03-30','2016-05-07',1),
  (8,2421, 'UPGRADE', '2017-08-19','2017-10-14',2),
  (9,2937, 'SALE', '2016-08-16','2016-09-26',3),
  (10,6194, 'RENEWAL', '2016-10-13','2016-12-09',4);
